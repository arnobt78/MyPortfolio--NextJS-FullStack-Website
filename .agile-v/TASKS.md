...
| TASK-0004 | REQ-0016 | P1 | Fill `CLAUDE.md`; AGENTS.md; README `proxy.ts` | done (C2) |
| TASK-0005 | REQ-0016 | P2 | Commit LICENSE SPDX line if Gate 1 includes it | cancelled (not in C2 scope) |
| TASK-0006 | REQ-0002 / 0009 | P2 | Add `lib/sentry-extension-noise.ts` to BUILD_MANIFEST | proposed |
